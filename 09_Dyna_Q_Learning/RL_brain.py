"""
Dyna Q-Learning 结合模型学习和直接强化学习

Q-Learning 和 模型学习结合：Tabular Dyna-Q
...
class EnvModel:
    ...
    def __init__(self, actions):
        # the simplest case is to think about the model is a memory which all past
